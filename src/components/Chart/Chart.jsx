      ...
      >
        ...
        <Legend />
        {
            ...
            selectedMetricsMap[chartIndex].map((metric, metircIndex) => {
                return(
                    <Line yAxisId={metircIndex}type="monotone" dataKey={`${metric}`} stroke="#82ca9d"dot={false} isAnimationActive ={false} key={`${metric}___line`} />
            ...
            selectedMetricsMap[chartIndex].map((metric, metircIndex) => {
                return(
                      <YAxis 
                        ...
                        orientation={'right'} 
                      >
                        <Label value={metricUnitMap[`${metric}`]} position="insideTopLeft" offset={10 + metircIndex*30} />
