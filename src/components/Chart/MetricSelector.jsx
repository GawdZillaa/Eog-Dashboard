  ...
  return (
    ...
    >
      <Box display="flex" flex="1" flexDirection="row">
        {mode === 'focus' ? (
          <Box display="flex" justifyContent="center" alignItems="center" bgcolor="" flex="1" flexDirection="row">
            <Tooltip title="Return To Multi View">
              <ArrowBack
                style={{ color: red[500] }}
                aria-label="Return To Multi View"
        ...
        >
          ...
          <Box flex="6">
            <FormControl variant="outlined" fullWidth={true}>
              ...
              <Box boxShadow="3" borderRadius="50" overflow="hidden">
                <Select
                ...
                >
                  ...
                  {metricList &&
                    metricList.map((metricName, id) => {
                      return !selectedMetricsMap[chartIndex] || !selectedMetricsMap[chartIndex].includes(metricName) ? (
                        <MenuItem key={`${id}`} name={id} value={metricName}>
                          {metricName}
                        </MenuItem>
                      ) : null;
                    })}
        ...
        <Box display="flex" flex="5" bgcolor="" flexDirection="row">
          <Box flex={2} />
          <Box flex="8" bgcolor="" flexDirection="row" display="flex">
              ...
              selectedMetricsMap[chartIndex].map((metricString, index) => {
                return (
                  ...
                  >
                    ...
                    <Box flex="8" margin="7px" justifyContent="center" alignItems="center" display="flex">
                      {metricString}
                    </Box>
                  </Box>
                );
